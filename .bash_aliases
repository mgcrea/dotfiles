...
function open-static() { chrome "http://localhost:8080"; http-server $@ -c-1; }
...
if [[ $OSTYPE =~ "darwin" ]]; then
  ...
  alias update="sudo softwareupdate -i -a; sudo port selfupdate; sudo port upgrade outdated; npm update -g"
# Custom *NIX
else
